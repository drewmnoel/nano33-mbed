...
void DualPHYScan::on_init_complete(BLE::InitializationCompleteCallbackContext *event)
{
    ...
    _event_queue.call_in(10, this, &DualPHYScan::scan_coded_phy); // XXX
}
...
void DualPHYScan::advertise(void)
{
    ...
    ble::AdvertisingParameters adv_params
        (
         ...
         ble::adv_interval_t::min(), //500ms
         ble::adv_interval_t::max(), //500ms
         false);
...
void DualPHYScan::scan_coded_phy(void)
{
    ...
    ble::ScanParameters scan_params(
            ble::phy_t::LE_CODED,
            ble::scan_interval_t::min() ,// scan_interval = scan_interval_t::min(),
